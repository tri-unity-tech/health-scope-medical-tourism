        ...
        <div className='container gap-10 grid sm:grid-cols-2'>
          ...
          <div className='grid'>
            <div className='grid gap-4 sm:gap-10 grid-cols-2 grid-rows-16 grid-flow-col'>
              <div onMouseEnter={ () => handleCardHoverEnter(0)} onMouseLeave={handleCardHoverLeave} className={`shadow-lg rounded-xl overflow-hidden row-start-1 row-span-6 duration-500 ease-in p-4 flex flex-col gap-2 ${ cardHover === 0 ? 'bg-teal-500 text-white' : 'bg-teal-100 text-gray-700'} `}>
              ...
              <div onMouseEnter={ () => handleCardHoverEnter(1)} onMouseLeave={handleCardHoverLeave} className={`shadow-lg rounded-xl overflow-hidden row-start-2 row-span-6 duration-500 ease-in p-4 flex flex-col gap-2 ${ cardHover === 1 ? 'bg-blue-500 text-white' : 'bg-blue-100 text-gray-700'}`}>
            ...
            <div className='grid gap-4 sm:gap-10 grid-cols-2 grid-rows-16 grid-flow-col'>
              <div onMouseEnter={ () => handleCardHoverEnter(2)} onMouseLeave={handleCardHoverLeave} className={`shadow-lg rounded-xl overflow-hidden row-start-1 row-span-6 duration-500 ease-in p-4 flex flex-col gap-2 ${ cardHover === 2 ? 'bg-red-500 text-white' : 'bg-red-100 text-gray-700'}`}>
              ...
              <div onMouseEnter={ () => handleCardHoverEnter(3)} onMouseLeave={handleCardHoverLeave} className={`shadow-lg rounded-xl overflow-hidden row-start-2 row-span-6 duration-500 ease-in p-4 flex flex-col gap-2 ${ cardHover === 3 ? 'bg-orange-500 text-white' : 'bg-orange-100 text-gray-700'}`}>
