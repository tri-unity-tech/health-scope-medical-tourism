            ...
            <div className='flex flex-grow'>
              <div className='w-full flex flex-col'>
                ...
                <span className='flex items-center gap-2'>
                  <p className='text-white px-4 bg-teal-500 py-0 text-lg'>
                    Managing Director
                  </p>
                ...
                <span className='text-gray-500 flex flex-col gap-2 mt-5 text-sm md:text-[16px]'>
                  <p>
                    Mr Jerome Byiringino is the Co-founder at Health Scope
                    Medical Tourism and the managing director. Mr. Jerome has a
                    bachelor’s degree in Microbiology from India.{' '}
                  </p>
                  <p>
                    He is experienced in the field of medical tourism and
                    hospital admissions.
                  </p>
                  <p>
                    From June 2022- May 2023, he worked on a scientific research
                    in DNA Recombinant Technology at National Centre for
          ...
          <div className='w-full gap-10 sm:gap-40 flex flex-col md:flex-row justify-between'>
            <div className='flex order-1 md:order-0 flex-grow'>
              <div className='w-full flex flex-col'>
                ...
                <span className='text-gray-500 flex flex-col gap-2 mt-5 text-sm md:text-[16px]'>
                  <p>
                    Nelson is a Rwandan citizen and a specialist in Medical
                    Laboratory Science, Immunology and biomedicine. from India.{' '}
                  </p>
                  <p>
                    Nelson has a BSc Microbiology degree from Marwadi University
                    – India. He is a constant researcher on viral out breaks and
                    drug innovation. He is serving as the medical director and
                    company head of secretary at HSMT.
                  </p>
                </span>
              </div>
            </div>
